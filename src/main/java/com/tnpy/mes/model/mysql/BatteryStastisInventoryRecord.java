...
public class BatteryStastisInventoryRecord {
    ...
    private Integer dailyshipmentsnum;
    ...
    public Integer getDailyshipmentsnum() {
        return dailyshipmentsnum;
    }

    public void setDailyshipmentsnum(Integer dailyshipmentsnum) {
        this.dailyshipmentsnum = dailyshipmentsnum;
    }
}